...
\definecolor{vol}{HTML}{29123a}
\definecolor{eptype}{HTML}{170a20}      
\definecolor{epnum}{HTML}{863bbf}       
\definecolor{epattr}{HTML}{9c5ccc}
...
\newcommand{\img}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/BookV/#2.png}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\imgc}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/BookV/#2.jpg}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\gif}[4][12.5cm]{%
    \begin{figure}[H]
        ...
        {30}{../../../Image/BookVV/#2/#2.}{#3}{#4}                                      % Chỉ cần chèn tên tệp, lấy từ khung #3 tới #4
    \end{figure}
}
...
\newcommand{\vid}[3][12.5cm]{%
  \embedvideo{\includegraphics[width=#1]{../../../../Image/BookV/#2.png}}{#3.mp4}
}
...
\color{vol}{Void of Nothingness}
\\[-18pt]}                      
\fancyhead[RE]
{\device\fontsize{18pt}{18pt}\selectfont
\color{vol}{Vide de néant}
\\[-18pt]}                     
% Số chương
\fancyhead[RO]
...
\color{vol}{\textbf{($\varnothing$)}}
\\[-18pt]
}
\fancyhead[LE]
{\sen\fontsize{18pt}{18pt}\selectfont
\color{vol}{\textbf{voide}}
\ab\fontsize{18pt}{18pt}\selectfont
\color{vol}{\textbf{($\varnothing$)}}
\\[-18pt]}
% Chân trang
...
\begin{minipage}[c][0.25\textheight][t]{\textwidth}
    ...
    \centering
    {\huge \color{vol}{{\vnmsans Quyển Không Gian}}} \vspace{15pt}

    {\fontsize{50pt}{50pt}\selectfont \color{vol}{\vnmdisp NHỮNG MẢNH VỠ CỦA THỜI GIAN}}\vspace{15pt}

    {\Large \color{vol}{\vnmsans (Ngày cuối cùng tháng 11, 2021)}}
\end{minipage}
\vspace*{\fill}
...
%=======================================DANH SÁCH TẬP========================================
\newpage
\subsection*{\phantomsection\label{ep-V.I}}
\addcontentsline{toc}{section}{{\flaregothic{HISTOIRE \dawnland 1}} - Tờ đơn xin nghỉ định mệnh}
\vspace{-30pt}
\subfile{Episode/V-01}

\newpage
\subsection*{\phantomsection\label{ep-V.II}}
\addcontentsline{toc}{section}{{\flaregothic{HISTOIRE \dawnland 2}} - Khoảng không bí ẩn}
\vspace{-30pt}
\subfile{Episode/V-02}

\newpage
\subsection*{\phantomsection\label{ep-V.III}}
\addcontentsline{toc}{section}{{\flaregothic{HISTOIRE \dawnland 3}} - Đoàn tụ}
\vspace{-30pt}
\subfile{Episode/V-03}

\newpage
\subsection*{\phantomsection\label{ep-V.IV}}
{\addcontentsline{toc}{section}{\flaregothic{HISTOIRE \dawnland 4}} - Hai chị em từ thế giới khác}
\vspace{-30pt}
\subfile{Episode/V-04}

\newpage
\subsection*{\phantomsection\label{ep-V.V}}
\addcontentsline{toc}{section}{{\flaregothic{HISTOIRE \dawnland 5}} - Cuộc phiêu lưu của Kuon ở thế giới ``không-phải-là-Game''}
\vspace{-30pt}
\subfile{Episode/V-05}

\newpage
\subsection*{\phantomsection\label{ep-V.VI}}
\addcontentsline{toc}{section}{{\flaregothic{HISTOIRE \dawnland 6}} - Hành trình khép lại, một hành trình mới bắt đầu}
\vspace{-30pt}
\subfile{Episode/V-06}
%===========================================LỜI KẾT===========================================
\newpage
\section*{\phantomsection\label{outro}}
...
% \begin{center}
%     \textcolor{vol}
%     {\quincy\Huge\textbf{TOME \ruby{V}{\ab VOIDE}\ TERMINE !}} \\[1ex]
%     \textcolor{vol}
%     {\vnmdisp\Huge\textbf{(QUYỂN \ruby{KHOẢNG TRỐNG}{虚無/ボイド}\ HOÀN THÀNH!)}}
% \end{center}
