...
\definecolor{vol}{HTML}{39cd05}
\definecolor{eptype}{HTML}{40ac04}      
\definecolor{epnum}{HTML}{52ec1a}       
\definecolor{epattr}{HTML}{a6f074}
...
% Màu đội
\definecolor{T1}{HTML}{1F0972}
\definecolor{T2}{HTML}{86432E}
\definecolor{T3}{HTML}{923E71}
\definecolor{T4}{HTML}{A32192}
\definecolor{T5}{HTML}{100698}
\definecolor{T6}{HTML}{A65402}
...
\color{vol}{Floor 952: Intricate Birthday Rave}
\\[-18pt]}                      
\fancyhead[RE]
{\device\fontsize{18pt}{18pt}\selectfont
\color{vol}{Étage 952 : Fête d'anniversaire complexe}
\\[-18pt]}                     
% Số chương
\fancyhead[RO]
...
\begin{center}
    {\huge \color{vol}{{\frank volume \hbrk BIRTHDAY}}} \vspace{15pt}
    
    {\fontsize{50pt}{50pt}\selectfont \color{vol}{\vnmdisp SINH NHẬT CỦA KUON}}\vspace{15pt}
    
    {\Large \color{vol}{\vnmsans (Sinh nhật Hikawa Kuon - năm 2021)}}
\end{center}
...
%=======================================DANH SÁCH TẬP========================================
\newpage
\subsection*{\phantomsection\label{ep-A.I}}
\addcontentsline{toc}{section}{\flaregothic{HISTOIRE \brian 1}}
\vspace{-30pt}
\subfile{Episode/A-1}

\newpage
\subsection*{\phantomsection\label{ep-A.II}}
\addcontentsline{toc}{section}{\flaregothic{HISTOIRE \brian 2}}
\vspace{-30pt}
\subfile{Episode/A-2}

\newpage
\subsection*{\phantomsection\label{ep-A.III}}
\addcontentsline{toc}{section}{\flaregothic{HISTOIRE \brian 3}}
\vspace{-30pt}
\subfile{Episode/A-3}

\newpage
\subsection*{\phantomsection\label{ep-A.IV}}
\addcontentsline{toc}{section}{\flaregothic{HISTOIRE \brian 4}}
\vspace{-30pt}
\subfile{Episode/A-4}

\newpage
\subsection*{\phantomsection\label{ep-A.V}}
\addcontentsline{toc}{section}{\flaregothic{HISTOIRE \brian 5}}
\vspace{-30pt}
\subfile{Episode/A-5}

\newpage
\subsection*{\phantomsection\label{ep-A.VI}}
\addcontentsline{toc}{section}{\flaregothic{HISTOIRE \brian 6}}
\vspace{-30pt}
\subfile{Episode/A-6}
%===========================================LỜI KẾT===========================================
\newpage
...
\begin{center}
	\textcolor{vol}
    {\quincy\Huge\textbf{TOME \ruby{A}{\ab ANNIVERSAIRE}\ TERMINE !}} \\[1ex]
    \textcolor{vol}
    {\vnmdisp\Huge\textbf{(QUYỂN \ruby{SINH NHẬT}{誕生日/バースデー}\ HOÀN THÀNH!)}}
\end{center}
