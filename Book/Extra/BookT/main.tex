...
\newcommand{\img}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../Image/BookT/#2.png}                    % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\gif}[4][12.5cm]{%
    \begin{figure}[H]
        ...
        {30}{../../../Image/BookT/#2/#2.}{#3}{#4}                                  % Chỉ cần chèn tên tệp, lấy từ khung #3 tới #4
    \end{figure}
}
...
\newcommand{\vid}[3][12.5cm]{%
  \embedvideo{\includegraphics[width=#1]{../../../Image/BookT/#2.png}}{#3.mp4}
}
...
\color{vol}{The Tet Celebration}
\\[-18pt]}                      
\fancyhead[RE]
{\device\fontsize{18pt}{18pt}\selectfont
\color{vol}{La célébration du Têt}
\\[-18pt]}                     
% Số chương
\fancyhead[RO]
