...
\newcommand{\img}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/Book7/#2.png}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\imgc}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/Book7/#2.jpg}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\gif}[4][12.5cm]{%
    \begin{figure}[H]
        ...
        {30}{../../../../Image/Book7/#2/#2.}{#3}{#4}                                      % Chỉ cần chèn tên tệp, lấy từ khung #3 tới #4
    \end{figure}
}
...
\newcommand{\vid}[3][12.5cm]{%
  \embedvideo{\includegraphics[width=#1]{../../../../Image/Book7/#2.png}}{#3.mp4}
}
...
\color{vol}{The Hikawa's Dormitory}
\\[-18pt]}                      
\fancyhead[RE]
{\device\fontsize{18pt}{18pt}\selectfont
\color{vol}{Le dortoir de Hikawa}
\\[-18pt]}                     
% Số chương
\fancyhead[RO]
...
\begin{minipage}[c][0.25\textheight][t]{\textwidth}
    ...
    \centering
    {\huge \color{vol}{{\frank volume \hbrk DORMITORY}}} \vspace{15pt}

    {\fontsize{50pt}{50pt}\selectfont \color{vol}{\vnmdisp (KÝ TÚC XÁ NHÀ HIKAWA)}}\vspace{15pt}

    % {\Large \color{vol}{\vnmsans (Mùa đông năm 2020 - 2021)}}
\end{minipage}
\vspace*{\fill}
...
\addcontentsline{toc}{section}{\flaregothic{HISTOIRE 1}} 
\subfile{Episode/D-1}

% \newpage
% \section*{\phantomsection\label{epd.2}} 
% \addcontentsline{toc}{section}{\flaregothic{HISTOIRE 2}}
% \subfile{Episode/D-2}

% \newpage
% \section*{\phantomsection\label{epd.3}} 
% \addcontentsline{toc}{section}{\flaregothic{HISTOIRE 3}} 
% \subfile{Episode/D-3}

\newpage
\section*{\phantomsection\label{epd.4}} 
\addcontentsline{toc}{section}{\flaregothic{HISTOIRE 4}} 
\subfile{Episode/D-4}
%===========================================LỜI KẾT===========================================
% \newpage
