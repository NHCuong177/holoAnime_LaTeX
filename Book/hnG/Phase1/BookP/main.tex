...
% Màu nhân vật
\definecolor{vol}{RGB}{255, 80, 80}
\definecolor{eptype}{RGB}{240, 10, 15}      
\definecolor{epnum}{RGB}{200, 18, 48}       
\definecolor{epattr}{RGB}{247, 63, 67}
...
\newcommand{\img}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/BookP/#2.png}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\imgc}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/BookP/#2.jpg}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\gif}[4][12.5cm]{%
    \begin{figure}[H]
        ...
        {30}{../../../../Image/BookP/#2/#2.}{#3}{#4}                                      % Chỉ cần chèn tên tệp, lấy từ khung #3 tới #4
    \end{figure}
}
...
{\device\fontsize{18pt}{18pt}\selectfont
  \color{vol}{Miko's Duty}
  \\[-18pt]}
\fancyhead[RE]
{\device\fontsize{18pt}{18pt}\selectfont
  \color{vol}{Le devoir de Miko}
  \\[-18pt]}
% Số chương
\fancyhead[RO]
...
\begin{minipage}[c][0.25\textheight][b]{\textwidth}
  \centering
  \includegraphics[width=12cm]{../../../Logo/mnt.png}
...
\begin{minipage}[c][0.25\textheight][t]{\textwidth}
  ...
  \centering
  {\huge \color{vol}{{\vnmsans Quyển Tiền truyện}}} \vspace{15pt}

  {\fontsize{50pt}{50pt}\selectfont \color{vol}{\vnmdisp NHỮNG CÂU CHUYỆN THƯỜNG NHẬT\\CỦA VU NỮ}}\vspace{15pt}

  {\Large \color{vol}{\vnmsans (2018 - 2019)}}
\end{minipage}
\vspace*{\fill}
...
\addcontentsline{toc}{section}{\vnmsans{Giới thiệu}}
{\centering\vnmsans\Large\textcolor{vol}{Giới thiệu}\par}
\subfile{intro}

% %===================DANH SÁCH TẬP===========================
% \newpage
% \section*{\phantomsection\label{ep-p1}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE -10} \cafeteria | P-1}: Một ngày của Sakura Miko} \vspace{-30pt}
% \subfile{Episode/P-1}

% \newpage
% \section*{\phantomsection\label{ep-p2}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE -9} \cafeteria | P-2}: Vu nữ ưu tú}
% \vspace{-30pt}
% \subfile{Episode/P-2}

% \newpage
% \section*{\phantomsection\label{ep-p3}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE -8} \cafeteria | P-3}: Cuối năm cùng với Thần}
% \vspace{-30pt}
% \subfile{Episode/P-3}

% \newpage
% \section*{\phantomsection\label{ep-p4}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE -7} \cafeteria | P-4}: Con sao biển trên cây thông Nô-en}
% \vspace{-30pt}
% \subfile{Episode/P-4}

% \newpage
% \section*{\phantomsection\label{ep-p5}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE -6} \cafeteria | P-5}: Đầu năm với Vu nữ ưu tú}
% \vspace{-30pt}
% \subfile{Episode/P-5}

% \newpage
% \section*{\phantomsection\label{ep-p6}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE -5} \cafeteria | P-6}: Gọi điện}
% \vspace{-30pt}
% \subfile{Episode/P-6}

% \newpage
% \section*{\phantomsection\label{ep-p7}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE -4} \cafeteria | P-7}: Roboco tới chơi nhà}
% \vspace{-30pt}
% \subfile{Episode/P-7}

% \newpage
% \section*{\phantomsection\label{ep-p8}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE -3} \cafeteria | P-8}: Trò chuyện}
% \vspace{-30pt}
% \subfile{Episode/P-8}

% \newpage
% \section*{\phantomsection\label{ep-p9}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE -2} \cafeteria | P-9}: Vòng lặp thời gian}
% \vspace{-30pt}
% \subfile{Episode/P-9}

% \newpage
% \section*{\phantomsection\label{ep-p10}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE -1} \cafeteria | P-10}: Ngày Valentine với Vu nữ}
% \vspace{-30pt}
% \subfile{Episode/P-10}

\newpage
\section*{\phantomsection\label{s0}}
\addcontentsline{toc}{section}{{\flaregothic{SPÉCIAL N} \cafeteria | S-0}: Một hành trình mới}
\vspace{-30pt}
\subfile{Episode/S-0}
...
% \begin{center}
%   \textcolor{vol}
%   {\quincy\Huge\textbf{PREQUELLE TERMINE !} \\[1ex]
