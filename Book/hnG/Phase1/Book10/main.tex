...
\definecolor{eptype}{HTML}{430022}      
...
\color{vol}{Floor 1010: A Lullaby for Days of Great Autumn Calamity}
\\[-18pt]}                      
\fancyhead[RE]
{\device\fontsize{18pt}{18pt}\selectfont
\color{vol}{Étage 1010 : Le chant de berceuse des jours de désastre d'automne}
\\[-18pt]}                     
% Số chương
\fancyhead[RO]
...
\begin{center}
    {\huge \color{vol}{{\frank volume \hbrk TEN}}} \vspace{15pt}
    
    {\fontsize{50pt}{50pt}\selectfont \color{vol}{\vnmdisp (KHÚC HÁT RU NHỮNG NGÀY MÙA THU THẢM HỌA LỚN)}}\vspace{15pt}
...
%=======================================DANH SÁCH TẬP========================================
% \newpage
% \section*{\phantomsection\label{ep10.1}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 121}} 
% \subfile{Episode/10-1}

% \newpage
% \section*{\phantomsection\label{ep10.2}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 122}}
% \subfile{Episode/10-2}

% \newpage
% \section*{\phantomsection\label{ep10.3}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 123}} 
% \subfile{Episode/10-3}

% \newpage
% \section*{\phantomsection\label{ep10.4}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 124}} 
% \subfile{Episode/10-4}

% \newpage
% \section*{\phantomsection\label{ep10.5}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 125}}  
% \subfile{Episode/10-5}

% \newpage
% \section*{\phantomsection\label{ep10.6}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 126}} 
% \subfile{Episode/10-6}

% \newpage
% \section*{\phantomsection\label{ep10.7}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 127}} 
% \subfile{Episode/10-7}

% \newpage
% \section*{\phantomsection\label{epC.5}} 
% \addcontentsline{toc}{section}{\flaregothic{PERSONNALISÉ {\vnmdisp NĂM}}} 
% \subfile{Episode/C-5}

% \newpage
% \section*{\phantomsection\label{epS.23}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 128/SPÉCIAL {\ab XXIII}}} 
% \subfile{Episode/S-23}

% \newpage
% \section*{\phantomsection\label{epC.5}} 
% \addcontentsline{toc}{section}{\flaregothic{PERSONNALISÉ {\vnmdisp SÁU}}} 
% \subfile{Episode/C-6}

% \newpage
% \section*{\phantomsection\label{ep10.8}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 129}}
% \subfile{Episode/10-8}
 
% \newpage
% \section*{\phantomsection\label{ep10.9}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 130}}
% \subfile{Episode/10-9}

% \newpage
% \section*{\phantomsection\label{ep10.10}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 131}}
% \subfile{Episode/10-10}

% \newpage
% \section*{\phantomsection\label{ep10.11}} 
% \addcontentsline{toc}{section}{\flaregothic{ÉPISODE 132}}
% \subfile{Episode/10-11}

\newpage
\section*{\phantomsection\label{ep10.12}} 
\addcontentsline{toc}{section}{\flaregothic{ÉPISODE 133}}
\subfile{Episode/10-12}
...
% \begin{center}
% 	\textcolor{vol}
%     {\quincy\Huge\textbf{TOME \ruby{10}{\ab DIX}\ - ACTE I TERMINE !} \\[1ex]
%     \vnmdisp\Huge\textbf{(QUYỂN SỐ \ruby{MƯỜI}{十/じゅう}\ - HỒI \ruby{MỘT}{壹/いち}\ HOÀN THÀNH!)}}
% \end{center}
% \rainbowcolor
% \begin{center}
%     {\ab\Huge\textbf{À SUIVRE\dots} \\[1ex]
%     \vnmdisp\Huge\textbf{(CÒN NỮA\dots)}}
% \end{center}
% \unrainbowcolor
