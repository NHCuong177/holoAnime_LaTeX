...
% Màu của sách
\definecolor{vol}{HTML}{19B7B3}
\definecolor{eptype}{HTML}{4ae6e7}      
\definecolor{epnum}{HTML}{16a5a2}       
\definecolor{epattr}{HTML}{a4f4f2}
...
\newcommand{\img}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/Book3/#2.png}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\imgc}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/Book3/#2.jpg}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\gif}[4][12.5cm]{%
    \begin{figure}[H]
        ...
        {30}{../../../../Image/Book3/#2/#2.}{#3}{#4}                                      % Chỉ cần chèn tên tệp, lấy từ khung #3 tới #4
    \end{figure}
}
...
\newcommand{\vid}[3][12.5cm]{%
  \embedvideo{\includegraphics[width=#1]{../../../../Image/Book3/#2.png}}{#3.mp4}
}
...
\color{vol}{Fantasy in the Snowstorm}
\\[-18pt]}                      
\fancyhead[RE]
{\device\fontsize{18pt}{18pt}\selectfont
\color{vol}{Fantasme dans la tempête de neige}
\\[-18pt]}                     
% Số chương
\fancyhead[RO]
...
\begin{minipage}[c][0.25\textheight][t]{\textwidth}
    ...
    \centering
    {\huge \color{vol}{{\vnmsans Quyển số Ba}}} \vspace{15pt}

    {\fontsize{50pt}{50pt}\selectfont \color{vol}{\vnmdisp (KỲ ẢO GIỮA BÃO TUYẾT)}}\vspace{15pt}
    
    {\Large \color{vol}{\vnmsans (Mùa đông năm 2019 - 2020)}}
\end{minipage}
\vspace*{\fill}
...
%=======================================DANH SÁCH TẬP========================================
% \newpage
% \section*{\phantomsection\label{ep3.1}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 30 \cafeteria | 3-1}} - Hồn Mát-xư, da con chó}
% \vspace{-30pt}
% \subfile{Episode/3-01}

% \newpage
% \section*{\phantomsection\label{ep3.2}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 31 \cafeteria | 3-2}} - Ván cờ lật (ô-thê-lô) định mệnh}
% \vspace{-30pt}
% \subfile{Episode/3-02}

% \newpage
% \section*{\phantomsection\label{ep3.3}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 32 \cafeteria | 3-3}} - Bát cơm bò và người cá giao hàng}
% \vspace{-30pt}
% \subfile{Episode/3-03}

% \newpage
% \section*{\phantomsection\label{ep3.4}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 33 \cafeteria | 3-4}} - Nhịn ăn}
% \vspace{-30pt} 
% \subfile{Episode/3-04}

\newpage
\section*{\phantomsection\label{ep3.6}} 
\addcontentsline{toc}{section}{{\flaregothic{SPÉCIAL III \cafeteria | S-3}} - Fubuki bé con}
\vspace{-30pt}
\subfile{Episode/S-03}

% \newpage
% \section*{\phantomsection\label{ep3.5}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 34 \cafeteria | 3-5}} - Kịch Comiket II - Shion bị kẹt tường}
% \vspace{-30pt}
% \subfile{Episode/3-05}

% \newpage
% \section*{\phantomsection\label{ep3.6}} 
% \addcontentsline{toc}{section}{{\flaregothic{SPÉCIAL IV \cafeteria | S-4}} - Fubuki bé con}
% \vspace{-30pt}
% \subfile{Episode/S-04}

% \newpage
% \section*{\phantomsection\label{ep3.7}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 35 \cafeteria | 3-6}} - Nặn thú}
% \vspace{-30pt}
% \subfile{Episode/3-06}

% \newpage
% \section*{\phantomsection\label{ep3.8}} 
% \addcontentsline{toc}{section}{{\flaregothic{SPÉCIAL V \cafeteria | S-5}} - Cuộc thi các Vtuber trượt tuyết nhảy xa đầu năm mới}
% \vspace{-30pt}
% \subfile{Episode/S-05}

% \newpage
% \section*{\phantomsection\label{ep3.9}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 36 \cafeteria | 3-7}} - Căn bệnh nghiện trò chơi điện tử}
% \vspace{-30pt}
% \subfile{Episode/3-07}

% \newpage
% \section*{\phantomsection\label{ep3.10}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 37 \cafeteria | 3-8}} - Cú lừa liên hoàn}
% \vspace{-30pt} 
% \subfile{Episode/3-08}

% \newpage
% \section*{\phantomsection\label{ep3.11}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 38/SPÉCIAL VI \cafeteria | S-2}} - Phim\dots\ nhưng không phải là phim!}
% \vspace{-30pt}
% \subfile{Episode/S-06}

% \newpage
% \section*{\phantomsection\label{ep3.12}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 39 \cafeteria | 3-9}} - Chiếc cốc của Aki}
% \vspace{-30pt} 
% \subfile{Episode/3-09}

% \newpage
% \section*{\phantomsection\label{ep3.13}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 40 \cafeteria | 3-10}} - Ta là vua muôn loài!}
% \vspace{-30pt} 
% \subfile{Episode/3-10}

% \newpage
% \section*{\phantomsection\label{ep3.14}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 41 \cafeteria | 3-11}} - Cuộc đi săn cua kỳ thú}
% \vspace{-30pt} 
% \subfile{Episode/3-11}

% \newpage
% \section*{\phantomsection\label{ep3.15}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 42 \cafeteria | 3-12}} - Rắn của ai}
% \vspace{-30pt} 
% \subfile{Episode/3-12}
...
% \begin{center}
% 	\textcolor{vol}
%     {\quincy\Huge\textbf{TOME \ruby{3}{\ab TROIS}\ TERMINE !} \\[1ex]
%     \vnmdisp\Huge\textbf{(QUYỂN SỐ \ruby{BA}{三/さん}\ HOÀN THÀNH!)}}
% \end{center}
