...
% \addcontentsline{toc}{section}{{\flaregothic{SPÉCIAL XI \cafeteria | S-10}} - Bức ảnh kỷ niệm}
% \vspace{-30pt}
...
% \newpage
% \section*{\phantomsection\label{S5.2}} 
% \addcontentsline{toc}{section}{{\flaregothic{SPÉCIAL XII \cafeteria | S-11}} - \sout{Yamada} Aqua mất trí nhớ}
% \vspace{-30pt}
...
% \addcontentsline{toc}{section}{\flaregothic{{SPÉCIAL XIII \cafeteria | S-12}} - Cùng học (tất cả trừ) cách làm cà ri}
% \vspace{-30pt}
