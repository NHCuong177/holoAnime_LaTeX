...
\definecolor{vol}{HTML}{009665}
\definecolor{eptype}{HTML}{009261}      
\definecolor{epnum}{HTML}{01FFAA}       
\definecolor{epattr}{HTML}{33ffbb}
...
\color{vol}{The Winter Wonder Trio}
\\[-18pt]}                      
\fancyhead[RE]
{\device\fontsize{18pt}{18pt}\selectfont
\color{vol}{Le trio merveilleux de l'hiver}
\\[-18pt]}                     
% Số chương
\fancyhead[RO]
...
\begin{minipage}[c][0.25\textheight][t]{\textwidth}
    ...
    \centering
    {\huge \color{vol}{{\frank volume \hbrk SEVEN}}} \vspace{15pt}

    {\fontsize{50pt}{50pt}\selectfont \color{vol}{\vnmdisp (BỘ BA ĐÔNG LẠNH KỲ DIỆU)}}\vspace{15pt}
...
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 83 \cafeteria | 7-1}} - Thảm họa Fubzilla}
% \vspace{-30pt}
% \subfile{Episode/7-01}

% \newpage
% \section*{\phantomsection\label{ep7.2}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 84 \cafeteria | 7-2}} - Hỏng rồi!}
% \vspace{-30pt}
% \subfile{Episode/7-02}

% \newpage
% \section*{\phantomsection\label{ep7.3}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 84 \cafeteria | 7-3}} - Halloween\dots\ muộn!}
% \vspace{-30pt}
% \subfile{Episode/7-03}

% \newpage
% \section*{\phantomsection\label{epS.15}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 86/SPÉCIAL XV \cafeteria | S-15}} - Gặp nhau cuối năm 2020: Chuyện chưa kể trong 2\textsuperscript{nd} Fes}
% \vspace{-30pt}
% \subfile{Episode/S-15}

% \newpage
% \section*{\phantomsection\label{epS.16}} 
% \addcontentsline{toc}{section}{\flaregothic{{SPÉCIAL XVI \cafeteria | S-16}} - Shion quên lời}
% \vspace{-30pt}
% \subfile{Episode/S-16}

% \newpage
% \section*{\phantomsection\label{ep7.4}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 87 \cafeteria | 7-4}} - Tia hạnh phúc}
% \vspace{-30pt}
% \subfile{Episode/7-04}

% \newpage
% \section*{\phantomsection\label{ep7.5}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 88 \cafeteria | 7-5}} - Nào ta cùng bay lên cao!}
% \vspace{-30pt}
% \subfile{Episode/7-05}

% \newpage
% \section*{\phantomsection\label{ep7.6}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 89 \cafeteria | 7-6}} - Chuyện về cốc cà phê}
% \vspace{-30pt}
% \subfile{Episode/7-06}

% \newpage
% \section*{\phantomsection\label{ep7.7}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 90 \cafeteria | 7-7}} - Mèo hay Cáo?}
% \vspace{-30pt}
% \subfile{Episode/7-07}

% \newpage
% \section*{\phantomsection\label{ep7.8}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 91 \cafeteria | 7-8}} - Lamy bợm rượu}
% \vspace{-30pt}
% \subfile{Episode/7-08}

% \newpage
% \section*{\phantomsection\label{ep7.9}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 92 \cafeteria | 7-9}} - Botan và chuyện về xe ba bánh}
% \vspace{-30pt}
% \subfile{Episode/7-09}

% \newpage
% \section*{\phantomsection\label{epS.17}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 93/SPÉCIAL XVII \cafeteria | S-17}} - Bản kế hoạch tai hại}
% \vspace{-30pt}
% \subfile{Episode/S-17}

% \newpage
% \section*{\phantomsection\label{ep7.10}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 94 \cafeteria | 7-10}} - Hầu gái}
% \vspace{-30pt}
% \subfile{Episode/7-10}

\newpage
\section*{\phantomsection\label{ep7.11}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 95 \cafeteria | 7-11}} - Cùng dọn dẹp và trang trí căn phòng!}
\vspace{-30pt}
\subfile{Episode/7-11}
%===========================================LỜI KẾT===========================================
\newpage
...
% \begin{center}
% 	\textcolor{vol}
%     {\quincy\Huge\textbf{TOME \ruby{7}{\ab SEPT}\ TERMINE !} \\[1ex]
%     \vnmdisp\Huge\textbf{(QUYỂN SỐ \ruby{BẢY}{七/なな}\ HOÀN THÀNH!)}}
% \end{center}
