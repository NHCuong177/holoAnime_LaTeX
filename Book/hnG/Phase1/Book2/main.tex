...
% Màu của sách
\definecolor{vol}{HTML}{2f5496}
\definecolor{eptype}{HTML}{0070c0}      
\definecolor{epnum}{HTML}{00b0f0}       
\definecolor{epattr}{HTML}{9cc2e5}
...
\definecolor{Yubiyubi}{HTML}{febd00}
\definecolor{Okanya}{HTML}{bd34a4}
\definecolor{Yomemi}{HTML}{898bfe}
...
\newcommand{\img}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/Book2/#2.png}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\imgc}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/Book2/#2.jpg}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\gif}[4][12.5cm]{%
    \begin{figure}[H]
        ...
        {30}{../../../../Image/Book2/#2/#2.}{#3}{#4}                                      % Chỉ cần chèn tên tệp, lấy từ khung #3 tới #4
    \end{figure}
}
...
\newcommand{\vid}[3][12.5cm]{%
  \embedvideo{\includegraphics[width=#1]{../../../../Image/Book2/#2.png}}{#3.mp4}
}
...
{\device\fontsize{18pt}{18pt}\selectfont
    \color{vol}{Autumn of Madness}
    \\[-18pt]}
\fancyhead[RE]
{\device\fontsize{18pt}{18pt}\selectfont
    \color{vol}{L'automne de la délires}
    \\[-18pt]}
% Số chương
\fancyhead[RO]
...
\begin{minipage}[c][0.25\textheight][t]{\textwidth}
    ...
    \centering
    {\huge \color{vol}{{\vnmsans Quyển số Hai}}} \vspace{15pt}

    {\fontsize{50pt}{50pt}\selectfont \color{vol}{\vnmdisp (MÙA THU CỦA SỰ HỖN ĐỘN)}}\vspace{15pt}

    {\Large \color{vol}{\vnmsans (Mùa thu năm 2019)}}
\end{minipage}
\vspace*{\fill}
...
%=======================================DANH SÁCH TẬP========================================
\newpage
\section*{\phantomsection\label{ep2.1}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 17 \cafeteria | 2-1}} - Câu chuyện ma của Sora}
\vspace{-30pt}
\subfile{Episode/2-01}

% \newpage
% \section*{\phantomsection\label{ep2.2}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 18/SPÉCIAL II \cafeteria | S-2}} - Bài ca thể dục tập tạ}
% \vspace{-30pt}
% \subfile{Episode/S-02}

% \newpage
% \section*{\phantomsection\label{ep2.3}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 19 \cafeteria | 2-2}} - Bộ tứ FAMS (với giọng men-lì)}
% \vspace{-30pt}
% \subfile{Episode/2-02}

% \newpage
% \section*{\phantomsection\label{ep2.4}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 20 \cafeteria | 2-3}} - Kẻ cắp đôi bím tóc}
% \vspace{-30pt}
% \subfile{Episode/2-03}

\newpage
\section*{\phantomsection\label{ep2.5}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 21 \cafeteria | 2-4}} - Ba nàng khuyển ngự lâm}
\vspace{-30pt}
\subfile{Episode/2-04}

% \newpage
% \section*{\phantomsection\label{ep2.6}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 22 \cafeteria | 2-5}} - Cú xoay người tỷ yên}
% \vspace{-30pt}
% \subfile{Episode/2-05}

% \newpage
% \section*{\phantomsection\label{ep2.7}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 23 \cafeteria | 2-6}} - Khi Yomemi đến thế giới của \hll}
% \vspace{-30pt}
% \subfile{Episode/2-06}

\newpage
\section*{\phantomsection\label{ep2.8}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 24 \cafeteria | 2-7}} - Bóng đen bí ẩn}
\vspace{-30pt}
\subfile{Episode/2-07}

% \newpage
% \section*{\phantomsection\label{ep2.9}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 25 \cafeteria | 2-8}} - Super Holo-Mario Sises.}
% \vspace{-30pt}
% \subfile{Episode/2-08}

% \newpage
% \section*{\phantomsection\label{ep2.10}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 26 \cafeteria | 2-9}} - Chiếc bánh vòng Pon de Ring khổng lồ}
% \vspace{-30pt}
% \subfile{Episode/2-09}

% \newpage
% \section*{\phantomsection\label{ep2.11}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 27 \cafeteria | 2-10}} - Thú cưng Frappuccino}
% \vspace{-30pt}
% \subfile{Episode/2-10}

% \newpage
% \section*{\phantomsection\label{ep2.12}}
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 28 \cafeteria | 2-11}} - Cây mầm tòa nhà}
% \vspace{-30pt}
% \subfile{Episode/2-11}

% \newpage
% \section*{\phantomsection\label{ep2.13}} 
% \addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 29 \cafeteria | 2-12}} - Chiếc điện thoại thất lạc của Mel}
% \vspace{-30pt}
% \subfile{Episode/2-12}
...
% \begin{center}
% 	\textcolor{vol}
%     {\quincy\Huge\textbf{TOME \ruby{2}{\ab DEUX}\ TERMINE !} \\[1ex]
%     \vnmdisp\Huge\textbf{(QUYỂN SỐ \ruby{HAI}{二/に}\ HOÀN THÀNH!)}}
% \end{center}
\end{document}