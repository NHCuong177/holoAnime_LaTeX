...
\newcommand{\img}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/Book4/#2.png}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\imgc}[2][12.5cm]{%
    \begin{figure}[H]
        \centering
        \includegraphics[width=#1]{../../../../Image/Book4/#2.jpg}                        % Tự động thêm "Image/" vào trước tên tệp; chỉ cần chèn tên tệp
    \end{figure}
}
...
\newcommand{\gif}[4][12.5cm]{%
    \begin{figure}[H]
        ...
        {30}{../../../../Image/Book4/#2/#2.}{#3}{#4}                                      % Chỉ cần chèn tên tệp, lấy từ khung #3 tới #4
    \end{figure}
}
...
\newcommand{\vid}[3][12.5cm]{%
  \embedvideo{\includegraphics[width=#1]{../../../../Image/Book4/#2.png}}{#3.mp4}
}
...
\color{vol}{The Copyright Cipher of Spring}
\\[-18pt]}                      
\fancyhead[RE]
{\device\fontsize{18pt}{18pt}\selectfont
\color{vol}{Le code du droit d'auteur du printemps}
\\[-18pt]}                     
% Số chương
\fancyhead[RO]
...
\begin{minipage}[c][0.25\textheight][t]{\textwidth}
    ...
    \centering
    {\huge \color{vol}{{\frank volume \hbrk FOUR}}} \vspace{15pt}
    
    {\fontsize{50pt}{50pt}\selectfont \color{vol}{\vnmdisp (THUẬT TOÁN BẢN QUYỀN\\MÙA XUÂN)}}\vspace{15pt}
    
    {\Large \color{vol}{\vnmsans (Mùa xuân năm 2020)}}
\end{minipage}
\vspace*{\fill}
...
%=======================================DANH SÁCH TẬP========================================
\newpage
\section*{\phantomsection\label{ep4.1}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 43 \cafeteria | 4-1}} - Lạc đường}
\vspace{-30pt}
\subfile{Episode/4-01}

\newpage
\section*{\phantomsection\label{ep4.2}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 44 \cafeteria | 4-2}} - \ruby{Tetris}{Tê-trít-sừ}\ phiên bản người}
\vspace{-30pt}
\subfile{Episode/4-02}

\newpage
\section*{\phantomsection\label{ep4.3}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 45 \cafeteria | 4-3}} - Buổi ăn cà ri khó nhọc của Roboco}
\vspace{-30pt}
\subfile{Episode/4-03}

\newpage
\section*{\phantomsection\label{S4.1}} 
\addcontentsline{toc}{section}{{\flaregothic{SPÉCIAL VII \cafeteria | S-7}} - Buổi ASMR\dots\ kinh dị}
\vspace{-30pt}
\subfile{Episode/S-07}

\newpage
\section*{\phantomsection\label{ep4.4}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 46 \cafeteria | 4-4}} - Lao động (trong game) là vinh quang!}
\vspace{-30pt}
\subfile{Episode/4-04}

\newpage
\section*{\phantomsection\label{ep4.5}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 47 \cafeteria | 4-5}} - Hội chứng \ruby{Sazae}{Sa-da-ê}-san}
\vspace{-30pt}
\subfile{Episode/4-05}

\newpage
\section*{\phantomsection\label{ep4.6}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 48 \cafeteria | 4-6}} - Lao động (trong game) là vinh quang!}
\vspace{-30pt}
\subfile{Episode/4-06}

\newpage
\section*{\phantomsection\label{ep4.7}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 49 \cafeteria | 4-7}} - Cánh bay}
\vspace{-30pt}
\subfile{Episode/4-07}

\newpage
\section*{\phantomsection\label{ep4.8}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 50 \cafeteria | 4-8}} - Kẻ cắp bánh pudding}
\vspace{-30pt}
\subfile{Episode/4-08}

\newpage
\section*{\phantomsection\label{ep4.9}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 51 \cafeteria | 4-9}} - Chuyện về cái ti-vi}
\vspace{-30pt}
\subfile{Episode/4-09}

\newpage
\section*{\phantomsection\label{S4.2}} 
\addcontentsline{toc}{section}{{\flaregothic{SPÉCIAL VIII \cafeteria | S-8}} - Một năm đầy hỗn loạn!}
\vspace{-30pt}
\subfile{Episode/S-08}

\newpage
\section*{\phantomsection\label{ep4.10}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 52 \cafeteria | 4-10}} - Y*-G*-O* - tái chiến}
\vspace{-30pt}
\subfile{Episode/4-10}

\newpage
\section*{\phantomsection\label{ep4.11}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 53 \cafeteria | 4-11}} - Hänsel và Gretel phiên bản \textit{hologra}}
\vspace{-30pt}
\subfile{Episode/4-11}

\newpage
\section*{\phantomsection\label{ep4.12}}
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 54 \cafeteria | 4-12}} - Những nhà đánh giá ẩm thực tay mơ}
\vspace{-30pt}
\subfile{Episode/4-12}

\newpage
\section*{\phantomsection\label{ep4.13}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 55 \cafeteria | 4-13}} - Giải vô địch Vua chào hỏi}
\vspace{-30pt}
\subfile{Episode/4-13}

\newpage
\section*{\phantomsection\label{ep4.14}} 
\addcontentsline{toc}{section}{{\flaregothic{ÉPISODE 56 \cafeteria | 4-14}} - Làm việc tại nhà\dots?}
\vspace{-30pt}
\subfile{Episode/4-14}
...
% \begin{center}
% 	\textcolor{vol}
%     {\quincy\Huge\textbf{TOME \ruby{4}{\ab QUATRE}\ TERMINE !} \\[1ex]
%     \vnmdisp\Huge\textbf{(QUYỂN SỐ \ruby{BỐN}{四/よん}\ HOÀN THÀNH!)}}
% \end{center}
